...
**当前版本：v0.8.0**（详见 [CHANGELOG](CHANGELOG.md)）
...
| v0.8 大库与大文件稳定性加固 | 单个文件夹显示上限可配置（默认 2,000 / 可调 / 不限）、超大文件夹与超大文件（>300MB）保护、外部组件错误提示与用户文案审查 | ✅ |
...
见《[开发指南](docs/2026-09-22-MarkFlow开发指南-v1.3.md)》。
...
更多细节见《[使用指南](docs/2026-09-22-MarkFlow使用指南-v1.3.md)》。
...
测试策略、模块职责、发布流程与常见开发问题详见《[开发指南](docs/2026-09-22-MarkFlow开发指南-v1.3.md)》。
...
| [使用指南 v1.3](docs/2026-09-22-MarkFlow使用指南-v1.3.md) | 分功能操作手册与常见问题 |
| [开发指南 v1.3](docs/2026-09-22-MarkFlow开发指南-v1.3.md) | 环境搭建、架构、测试、发布流程、许可与合规 |
