...
import { ArrowLeft, FolderOpen, FolderPlus, Trash2 } from "lucide-react";
    ...
    <>
      ...
      <div className="space-y-1 border-t border-gray-100 px-2 py-2">
        <button type="button" onClick={closeManager}
          className="flex h-8 w-full items-center justify-center gap-1.5 rounded-lg bg-primary-600 text-[13px] font-medium text-white hover:bg-primary-700">
